...
while first_answer != "1" and first_answer != "2" and first_answer !=  "3":
    first_answer = input("Incorrect answer. Please, try again:  ")
...
while second_answer != "1" and second_answer != "2" and second_answer !=  "3":
    second_answer = input("Incorrect answer. Please, try again:  ")
...
while third_answer != "1" and third_answer != "2" and third_answer !=  "3":
    third_answer = input("Incorrect answer. Please, try again:  ")
...
while fourth_answer != "1" and fourth_answer != "2" and fourth_answer !=  "3":
    fourth_answer = input("Incorrect answer. Please, try again:  ")
...
while fifth_answer != "1" and fifth_answer != "2" and fifth_answer !=  "3":
    fifth_answer = input("Incorrect answer. Please, try again:  ")
...
while sixth_answer != "1" and sixth_answer != "2" and sixth_answer !=  "3":
    sixth_answer = input("Incorrect answer. Please, try again:  ")
...
while seventh_answer != "1" and seventh_answer != "2" and seventh_answer !=  "3":
    seventh_answer = input("Incorrect answer. Please, try again:  ")
...
while eigth_answer != "1" and eigth_answer != "2" and eigth_answer !=  "3":
    eigth_answer = input("Incorrect answer. Please, try again:  ")
...
while ninth_answer != "1" and ninth_answer != "2" and ninth_answer !=  "3":
    ninth_answer = input("Incorrect answer. Please, try again:  ")
...
while tenth_answer != "1" and tenth_answer != "2" and tenth_answer !=  "3":
    tenth_answer = input("Incorrect answer. Please, try again:  ")
